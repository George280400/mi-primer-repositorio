				...
				do {
					...
					try {
						...
						case 1: 
						    ...
						    marca = datos.nextLine().trim(); 

						    // 🔹 Validar antes de pedir más datos
						    boolean existe = false;
						    for (Moto m : imp.lista) {
						        if (m.getMarca().trim().equalsIgnoreCase(marca)) {
						            System.out.println("La moto con marca '" + m.getMarca() + "' ya está registrada. No se puede guardar.");
						            existe = true;
						            break;
						        }
						    }
						        ...
						        if (indice >= 0 && indice < imp.lista.size()) {
						            do {
						                ...
						                case 1:
						                    ...
						                    String nuevaMarca = datos.nextLine();

						                    boolean existe1 = false;
						                    for (Moto m : imp.lista) {
						                        if (m.getMarca().equalsIgnoreCase(nuevaMarca) && m != moto) {
						                            existe1 = true;
						                            break;
						                        }
						                    }
						                    ...
						                    if (existe1) {
						                        System.out.println("La marca '" + nuevaMarca + "' ya existe, no se puede guardar el cambio.");
						                    } else {
						                ...
						                case 4:
						                    ...
						                    System.out.println("Marchas actualizadas con éxito.");
						                    break;
